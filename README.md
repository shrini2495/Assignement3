...
<body background="Savageplnet.jpg" style="color: rgb(0, 0, 0); font-size: large; font-family: 'Times New Roman', Times, serif; background-color:Yellow; " >
    ...
    <button type = "button" onclick="location.href = 'https://www.facebook.com/ComicSensexyz/'"> <img src="facebookicon.png" alt="Website" height="50px" width="50px">  </button>
